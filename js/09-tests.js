...
function runTests() {
  ...
  check(document.getElementById('casino-seat-grid')?.dataset?.seatCount === '1', 'seat grid count attr');
  check(document.querySelectorAll('#casino-seat-grid .casino-seat').length === 1, 'single seat node');
  check(document.getElementById('casino-seat-human')?.dataset?.seat === '1', 'human seat marker');
  check(document.querySelectorAll('.casino-seat-spot').length >= 1, 'betting spot present');
  check(document.querySelectorAll('#casino-seat-grid .casino-seat .casino-seat-label').length === 1, 'seat label slot');
  check(document.querySelectorAll('#casino-seat-grid .casino-seat .casino-seat-spot').length === 1, 'seat spot circle');
  ...
  check(isSoloTableLayout({ tableLayout: 'solo' }), 'single-seat layout helper always true');
  check(document.body.classList.contains('casino-table-solo'), 'solo body class');
  check(!document.body.classList.contains('casino-table-full'), 'no full-table body class');
