...
class PlayStoreV1Tests(unittest.TestCase):
    ...
    def test_casino_theme_v57_overlay(self) -> None:
        ...
        self.assertIn("maybeStrategyFeedback", theme)
        self.assertIn("cq-strategy-tip", theme)
        self.assertIn("patchStrategyFeedback", theme)
        self.assertIn("__cqStrategyToastV61", theme)
        self.assertIn("chart says", theme)
        toast = (ROOT / "js" / "17-result-toast.js").read_text(encoding="utf-8")
        self.assertIn("maybeResultToast", toast)
        self.assertIn("patchResultToast", toast)
        self.assertIn("__cqResultToastV64", toast)
        self.assertIn("cq-result-tip", toast)
        self.assertIn("parseResultFromDom", toast)
        self.assertIn("17-result-toast.js", tutorial)
        self.assertIn("./js/17-result-toast.js", sw)
        ...
        self.assertIn("cq-result-tip", play_css)
        self.assertIn("cq-result-win", play_css)
        self.assertIn("cq-result-push", play_css)
        self.assertIn("bottom: auto !important", play_css)
        self.assertIn("body.casino-play-active #toast-stack", play_css)

    def test_soft_total_badge_v65(self) -> None:
        soft = (ROOT / "js" / "18-soft-total.js").read_text(encoding="utf-8")
        tutorial = (ROOT / "js" / "08-tutorial.js").read_text(encoding="utf-8")
        theme = (ROOT / "js" / "16-casino-theme.js").read_text(encoding="utf-8")
        sw = (ROOT / "sw.js").read_text(encoding="utf-8")
        play_css = (ROOT / "css" / "cq-v65-play.css").read_text(encoding="utf-8")
        ...
        self.assertIn("__cqSoftTotalV65", soft)
        self.assertIn("dressPlayerHands", soft)
        self.assertIn("cq-soft-hint", play_css)
        self.assertIn("cq-is-soft", play_css)
